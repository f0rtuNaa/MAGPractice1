...
- Определены дни недели с максимальной покупательской активностью
  ![Покупки по дням недели](images/9WeekDayProfit.png) 
- Найдены наиболее прибыльные и наиболее популярные категории товаров. Выявлены различия между объёмом заказов и фактической прибыльностью.
  ![Количество заказов по категориям](images/3CatCounrs.png)
  ![Прибыль по категориям](images/4CatProfit.png) 
- Построен тренд ежедневной активности покупателей
  ![Тренд](images/11Trend.png) 
